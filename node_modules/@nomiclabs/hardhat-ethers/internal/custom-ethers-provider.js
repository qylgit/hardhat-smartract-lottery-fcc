...
exports.CustomEthersProvider = void 0;
const ethers_1 = require("ethers");
const signers_1 = require("../signers");
const ethers_utils_1 = require("./ethers-utils");
class CustomEthersProvider {
    ...
    async getSigner(address) {
        ...
        if (typeof address === "number") {
            ...
            return signers_1.CustomEthersSigner.create(this, accounts[address]);
        }
        if (typeof address === "string") {
            return signers_1.CustomEthersSigner.create(this, address);
        }
    ...
    async getLogs(filter) {
        ...
        return logs.map((log) => this._wrapLog((0, ethers_utils_1.formatLog)(log)));
    }
    ...
    async waitForTransaction(hash, confirms, timeout) {
        const resolvedConfirms = confirms !== null && confirms !== undefined ? confirms : 1;
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (timeout !== undefined) {
                timer = setTimeout(async () => {
                    ...
                    reject((0, ethers_1.makeError)("timeout", "TIMEOUT", { reason: "timeout" }));
                }, timeout);
            }
...
exports.CustomEthersProvider = CustomEthersProvider;
...
//# sourceMappingURL=custom-ethers-provider.js.map