...
import type { BlockTag, TransactionRequest, Filter, FilterByBlockHash, ProviderEvent } from "ethers/types/providers";
...
export declare class CustomEthersProvider implements ethers.Provider {
    ...
    getSigner(address?: number | string): Promise<CustomEthersSigner>;
...
//# sourceMappingURL=custom-ethers-provider.d.ts.map